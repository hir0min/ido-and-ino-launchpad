...
import "./utils/INO1155.sol";
import "./interfaces/IFactory.sol";
import "./interfaces/IGovernance.sol";

contract Factory1155 is IFactory, OwnableUpgradeable {
        ...
        returns (address _nft)
    {
        ...
        bytes memory bytecode = type(INO1155).creationCode;
    ...
    function setWave(
        ...
        INO1155(_nft).setWave(_waveId, _limit, _startAt, _endAt);
